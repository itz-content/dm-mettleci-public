...
echo "=========================================="
oc apply -f cp4d-datastage-operator.yml --kubeconfig=$KUBECONFIG
...
oc apply -f cp4d-datastage-cr.yml --kubeconfig=$KUBECONFIG

echo "=========================================="
echo "Monitoring DataStage Installation..."
echo "=========================================="
while true; do
  STATUS=$(oc get datastage datastage-cr -n cpd -o jsonpath='{.status.dsStatus}' --kubeconfig=$KUBECONFIG 2>/dev/null)
